...
class external extends external_api {
    ...
    public static function serialize_level(level $level) {
        return [
            ...
            'badgeurl' => self::serialize_url($level->get_badge_url()),
     ...
     * @return array
     */
    public static function serialize_state(state $state, $withuser = false, $anonymously = false) {
        global $PAGE;
    ...
    public static function serialize_url(moodle_url $url = null) {
        global $CFG;
        $baseurl = $CFG->httpswwwroot . '/webservice';
     ...
     */
    public static function state_description($withuser = false) {
        $params = [
            'id' => new external_value(PARAM_INT),
