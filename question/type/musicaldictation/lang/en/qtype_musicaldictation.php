...
/**
 * Strings for component 'qtype_musicaldictation', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginname'] = 'Musical Dictation';
...
$string['pluginname_link'] = 'question/type/musicaldictation';
$string['pluginnameadding'] = 'Adding a Musical Dictation question';
$string['pluginnameediting'] = 'Editing a Musical Dictation question';
$string['pluginnamesummary'] = 'Transcribe a score from an audio file';
$string['privacy:metadata'] = 'The Musical Dictation question type plugin does not store any personal data.';
