...
/**
 * Test helpers for the musicaldictation question type.
 *
 * @package    qtype_musicaldictation
...
/**
 * Test helper class for the musicaldictation question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_musicaldictation_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a musicaldictation question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_musicaldictation_question
     */
    public function make_musicaldictation_question_frogtoad() {
        question_bank::load_question_definition_classes('musicaldictation');
        $sa = new qtype_musicaldictation_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Musical Dictation question';
        ...
        $sa->qtype = question_bank::get_qtype('musicaldictation');

        return $sa;
    }

    /**
     * Gets the question data for a musicaldictation question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_musicaldictation_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'musicaldictation';
        $qdata->name = 'Musical Dictation question';
    ...
    /**
     * Gets the question form data for a musicaldictation question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_musicaldictation_question_form_data_frogtoad() {
        $form = new stdClass();

        $form->name = 'Musical Dictation question';
    ...
    /**
     * Makes a musicaldictation question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_musicaldictation_question
     */
    public function make_musicaldictation_question_frogonly() {
        question_bank::load_question_definition_classes('musicaldictation');
        $sa = new qtype_musicaldictation_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Musical Dictation question';
    ...
    /**
     * Gets the question data for a musicaldictation questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_musicaldictation_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_musicaldictation_question
     */
    public function make_musicaldictation_question_escapedwildcards() {
        question_bank::load_question_definition_classes('musicaldictation');
        $sa = new qtype_musicaldictation_question();
        test_question_maker::initialise_a_question($sa);
