...
/**
 * Test helpers for the dictation1 question type.
 *
...
/**
 * Test helper class for the dictation1 question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_dictation1_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a dictation1 question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_dictation1_question
     */
    public function make_dictation1_question_frogtoad() {
        question_bank::load_question_definition_classes('dictation1');
        $sa = new qtype_dictation1_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Super Score Dictation question';
        ...
        $sa->qtype = question_bank::get_qtype('dictation1');

        return $sa;
    }

    /**
     * Gets the question data for a dictation1 question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_dictation1_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'dictation1';
        $qdata->name = 'Super Score Dictation question';
    ...
    /**
     * Gets the question form data for a dictation1 question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_dictation1_question_form_data_frogtoad() {
        $form = new stdClass();

        $form->name = 'Super Score Dictation question';
    ...
    /**
     * Makes a dictation1 question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_dictation1_question
     */
    public function make_dictation1_question_frogonly() {
        question_bank::load_question_definition_classes('dictation1');
        $sa = new qtype_dictation1_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Super Score Dictation question';
    ...
    /**
     * Gets the question data for a dictation1 questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_dictation1_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_dictation1_question
     */
    public function make_dictation1_question_escapedwildcards() {
        question_bank::load_question_definition_classes('dictation1');
        $sa = new qtype_dictation1_question();
        test_question_maker::initialise_a_question($sa);
