...
/**
 * Strings for component 'qtype_dictation1', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginname'] = 'Super Score Dictation';
...
$string['pluginname_link'] = 'question/type/dictation1';
$string['pluginnameadding'] = 'Adding a super Score Dictation question';
$string['pluginnameediting'] = 'Editing a Super Score Dictation question';
$string['pluginnamesummary'] = 'Fuckin awesome music score dictation. Boom!';
$string['privacy:metadata'] = 'The Super Score Dictation question type plugin does not store any personal data.';
